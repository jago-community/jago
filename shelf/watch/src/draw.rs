...
pub const PRIM_BUFFER_LEN: usize = 256;
...
pub fn draw() -> Result<(), Error> {
    log::warn!("== wgpu example ==");
    log::warn!("Controls:");
    log::warn!("  Arrow keys: scrolling");
    log::warn!("  PgUp/PgDown: zoom in/out");
    log::warn!("  b: toggle drawing the background");
    log::warn!("  a/z: increase/decrease the stroke width");
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        walk::walk_along_path(
            ...
            &mut walk::RepeatedPattern {
                callback: |position: Point, tangent: Vector, _index: f32| {
                    ...
                    cpu_primitives[arrows_prim_id as usize + arrow_count] = Primitive {
                        ...
                        translate: (position * 2.3 - vector(80.0, 80.0)).to_array(),
